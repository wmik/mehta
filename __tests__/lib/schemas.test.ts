    ...
    it('accepts valid analysis with all scores at minimum (1)', () => {
      const validAnalysis = {
        ...
        contentCoverage: {
          score: 1,
          rating: 'Missed',
          justification: 'Did not cover content'
        },
        facilitationQuality: {
          score: 1,
          rating: 'Poor',
          justification: 'Poor delivery'
        },
        protocolSafety: {
          score: 1,
          rating: 'Violation',
          justification: 'Protocol violation'
        },
    ...
    it('accepts valid analysis with all scores at maximum (3)', () => {
      const validAnalysis = {
        ...
        contentCoverage: {
          score: 3,
          rating: 'Complete',
          justification: 'Fully covered content'
        },
        facilitationQuality: {
          score: 3,
          rating: 'Excellent',
          justification: 'Excellent delivery'
        },
        protocolSafety: {
          score: 3,
          rating: 'Adherent',
          justification: 'Fully adherent'
        },
        riskDetection: { status: 'SAFE', explanation: 'No risk detected' }
      };
    ...
    it('accepts valid analysis with middle scores (2)', () => {
      const validAnalysis = {
        ...
        facilitationQuality: {
          score: 2,
          rating: 'Adequate',
          justification: 'Adequate delivery'
        },
        protocolSafety: {
          score: 2,
          rating: 'Minor Drift',
          justification: 'Minor drift'
        },
        riskDetection: { status: 'SAFE', explanation: 'No risk detected' }
      };
    ...
    it('accepts RISK status with quote', () => {
      const validAnalysis = {
        ...
        protocolSafety: {
          score: 3,
          rating: 'Adherent',
          justification: 'Adherent'
        },
        riskDetection: {
          status: 'RISK',
          quote: 'I want to hurt myself',
